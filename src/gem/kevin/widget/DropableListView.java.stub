...
public class DropableListView extends ListView implements DropAcceptable {
    private static final String TAG = "DropableListView";
    ...
    public DropableListView(Context context) {
        super(context);
    }

    public DropableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DropableListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mOnDropDelegate != null) {
            ...
            if (mOnDropDelegate.checkDropDataAcceptable(data, this)) {
                ...
                if (mOnDropDelegate.shouldDispathUnacceptableDropToParent(this)) {
                    ...
                    // Because a drop could be obscure when it happens on a ListView
